...
export const SentimentMeter = memo(({ value, classification, error }: SentimentMeterProps) => {
  ...
  return (
    <Card className="w-full max-w-75 border-zinc-200 dark:border-zinc-800">
      ...
      <CardContent className="flex flex-col items-center justify-center pt-4 pb-6">
        <div className="relative flex items-center justify-center">
          ...
          {/* Needle */}
          <div 
            className="absolute bottom-0 w-1 h-17.5 bg-zinc-800 dark:bg-zinc-100 origin-bottom rounded-full transition-transform duration-1000 ease-out z-10"
